...
import com.app.location.databinding.ActivityLocationBinding;
...
public class LocationActivity extends AppCompatActivity {
    ...
    public void buttonStartLocation(View view) {
        if (!mRequestingLocationUpdates) {
    ...
    private void setButtonsEnabledState() {
        if (mRequestingLocationUpdates) {
            binding.buttonStartLocation.setEnabled(false);
            binding.buttonStopLocation.setEnabled(true);
        } else {
            binding.buttonStartLocation.setEnabled(true);
            binding.buttonStopLocation.setEnabled(false);
        }
    }
